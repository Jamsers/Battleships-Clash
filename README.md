...
Built in Unity 5.6.7. Written in C#. Windows installer built with NSIS.  
3D models edited with Blender. Images edited with Photoshop. Textures made with Substance Painter.  
